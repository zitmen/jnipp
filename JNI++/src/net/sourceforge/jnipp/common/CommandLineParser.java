...
public class CommandLineParser {
     ...
     * parse it. If successful, the
     * <code>paramMap</code> contains all of the name/value pairs.
     *
     ...
     *
     * Used for debugging purposes and returns the value of
     * <code>paramMap.toString()</code>.
     *
