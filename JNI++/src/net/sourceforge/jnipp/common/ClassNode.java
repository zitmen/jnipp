 ...
 * dependency tree. It is utilized by the code generators and contains a list of
 * dependency nodes, method nodes, field nodes and numerous helper methods.
 *
...
public class ClassNode {
    ...
    /**
     * Map of loaded
     * <code>ClassNode</code> instances.
     *
     * This map contains a
     * <code>ClassNode</code> instance for each Java class that was encountered
     * in the traversal from the input class to the code generator.
     *
     * @see #getClassNode
     */
     ...
     *
     * This list contains all of the constructors declared for the class
     * represented by this
     * <code>ClassNode</code> instance.
     *
     * @see #getConstructors
     */
     ...
     *
     * This list contains all of the inner classes declared for the class
     * represented by this
     * <code>ClassNode</code> instance.
     *
     * @see #getInnerClasses
     ...
     *
     * This string uniquely identifies the class represented by this
     * <code>ClassNode</code> instance and is utilized in calls to JNI methods
     * such as
     * <code>GetFieldID()</code> and as a component of a method-identifying
     * string.
     *
     * @see #getJNIString
     */
     ...
     * <code>ClassNode</code> instance is an array, then this represents the
     ...
     * <code>ClassNode</code> instance.
     *
     * If the class represented by this
     * <code>ClassNode</code> instance has a superclass, then this points to its
     * <code>ClassNode</code>.
     *
     * @see #getSuperClass
     */
     ...
     *
     * If the class represented by this
     * <code>ClassNode</code> instance implements any interfaces, then this list
     * contains references to all of their
     * <code>ClassNode</code> instances.
     *
     * @see #getInterfaces
     */
     ...
     * <code>ClassNode</code> instances for all classes that are used either in
     * field, method or constructor declarations in the class represented by
     * this
     * <code>ClassNode</code> instance.
     *
     * @see #getDependencies
     ...
     *
     * If the type represented by this
     * <code>ClassNode</code> instance is an array, then this is a reference to
     * the
     * <code>ClassNode</code> instance of the component type of the array.
     *
     ...
     *
     * The
     * <code>loadedClassNodes</code> map contains all of the ClassNode objects
     * that have been loaded as part of the traversal. It will include class
     * nodes for the input class, its entire superclass inheritance ancestry,
     * its entire interface implementation ancestry, all of the inner classes,
     * parameter and return types that are encountered when evaluating the
     * original input class.
     *
     * If the ClassNode already exists, it is found and returned. If not, then
     * the ClassNode is created, added to the map and returned. The purpose of
     * the map is to ensure that a single instance of each ClassNode is loaded,
     * avoiding unnecessary work and possible negative side effects.
     *
     * @param fullyQualifiedClassName The fully qualified class name of the
     * ClassNode object
     * @return The ClassNode specified by
     * the <code>fullyQualifiedClassName</code> parameter
     ...
     * Class constructor.
     *
     * The class constructor accepts a string representation of the fully
     * qualified class name. This is utilized to obtain data about the class
     * through Java's introspection API. The queried data is utilized to build a
     * data structure that assists the various code generators.
     *
     ...
     * <code>getClassNode()</code> factory method after the instance is created.
     * It will generate the dependency, constructor, method, field, inner class
     * and exception lists and set various attributes that are used by the code
     * generators.
     *
     * @exception ClassNotFoundException
     * @see #getClassNode
     ...
     *
     * This method is called from the
     * <code>init()</code> method to generate the list of classes that are used
     * in member and method declarations as either parameters or return values.
     *
     * @exception ClassNotFoundException
     * @see #init
     * @see #dependencyList
     ...
     * by this
     * <code>ClassNode</code> instance is an interface.
     *
     * @return Boolean <emph>true</emph> if this is an interface,
     * <emph>false</emph>
     * otherwise.
     * @see #intfc
     */
    ...
    /**
     * Accessor to query if this is a
     * <code>Throwable</code> class.
     *
     * @return Boolean <emph>true</emph> if instances of this class can be
     * "thrown",
     ...
     * This method will return boolean <emph>true</emph> if the type represented
     * by this
     * <code>ClassNode</code> instance is primitive.
     *
     * @return Boolean <emph>true</emph> if this is primitive,
     * <emph>false</emph>
     * otherwise.
     * @see #primitive
     */
     ...
     * This method will return boolean <emph>true</emph> if the type represented
     * by this
     * <code>ClassNode</code> instance is an array.
     *
     ...
     *
     * This accessor method will return the Java class name of the type
     * represented by this
     * <code>ClassNode</code> instance (without the package prefix).
     *
     ...
     *
     * This accessor method will return the fully-qualified Java class name of
     * the type represented by this
     * <code>ClassNode</code> instance (with the package prefix).
     *
     ...
     *
     * This accessor method will return the equivalent C++ class name of the
     * type represented by this
     * <code>ClassNode</code> instance (without the namespace prefix).
     *
     ...
     * name of the type represented by this
     * <code>ClassNode</code> instance (with the namespace prefix).
     *
    ...
    public String getJNIString() {
        ...
        if (fullyQualifiedClassName.equals("void") == true) {
            ...
            if (fullyQualifiedClassName.equals("boolean") == true) {
                jniString = "Z";
            } else if (fullyQualifiedClassName.equals("long") == true) {
                jniString = "J";
            } else {
    ...
    public String getJNITypeName(boolean usePartialSpec) {
        if (needsProxy() == true) {
            return "::" + namespace + "::" + getCPPClassName() + "Proxy";
        }
