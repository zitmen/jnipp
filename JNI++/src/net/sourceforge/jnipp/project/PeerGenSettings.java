 ...
 * settings controlling the manner in which the C++ Peer Generator is run. Each
 * <code>Project</code> instance contains zero or one
 * <code>PeerGenSettings</code> instance.
 *
...
public class PeerGenSettings {
    ...
    /**
     * Generate virtual methods to accommodate implementation through
     * inheritance?
     */
    private boolean useInheritance = false;
    /**
     * Generate proxy and helper classes as parameters, return and attribute
     * types?
     */
     ...
     * this
     * <code>ProxyGenSettings</code> instance using the elements contained in
     * the supplied
     ...
     * specify the settings for the Peer Generator.
    ...
    public void initialize(Element elementNode)
        ...
        for (int i = 0; i < childNodes.getLength(); ++i) {
            ...
            } else if (currentChild.getNodeName().equals("proxygen") == true) {
    ...
    /**
     * Public accessor for the
     * <code>useInheritance</code> field.
     *
     * @return Boolean indicating whether to generate virtual methods with a
    ...
    /**
     * Public accessor for the
     * <code>useRichTypes</code> field.
     *
     * @return Boolean indicating whether to generate proxy and helper classes
     * for return, parameter and attribute types.
     * @see #useRichTypes
     */
     ...
     * <code>useRichTypes</code> field.
     *
     * @param useRichTypes Boolean indicating whether to generate proxy and
     * helper classes for return, parameter and attribute types.
     * @see #useRichTypes
     */
     ...
     * Generator settings.
     *
     * This method is utilized by the
     * <code>Project</code> class as part of its
     * <code>save()</code> method to serialize the Peer Generator settings,
     * along with all of its child settings.
     *
    ...
    /**
     * Public accessor for the owning
     * <code>Project</code>.
     *
