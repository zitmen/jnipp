 ...
 * settings controlling the manner in which the C++ Proxy Generator is run. Each
 * <code>Project</code> instance contains zero or one
 * <code>ProxyGenSettings</code> instance.
 *
...
public class ProxyGenSettings {
    ...
    /**
     * Generate proxy and helper classes for all parameter, return and field
     * types?
     */
     ...
     * specify the settings for the Proxy Generator.
     * @exception ProjectFormatException
     ...
     * <code>generateAttributeGetters</code> setting.
     *
    ...
    /**
     * Public accessor for the
     * <code>generateAttributeSetters</code> setting.
     *
    ...
    /**
     * Public accessor for the
     * <code>useInheritance</code> setting.
     *
     * @see #useInheritance
     */
    ...
    /**
     * Public accessor for the
     * <code>usrRichTypes</code> setting.
     *
     * @see #useRichTypes
     */
    ...
    /**
     * Public mutator for the
     * <code>useRichTypes</code> setting.
     *
     * @see #useRichTypes
     */
    ...
    /**
     * Public accessor for the
     * <code>generateInnerClasses</code> setting.
     *
     ...
     * <code>getDOMNode()</code> method to serialize the Proxy Generator
