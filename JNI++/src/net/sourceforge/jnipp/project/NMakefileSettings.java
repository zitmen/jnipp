 ...
 * controlling the manner in which the NMake makefile generator is run.  Each 
 * <code>Project</code> instance contains zero or one <code>NMakefileSettings</code>
 * instance.
 *
...
public class NMakefileSettings 
{
	 ...
	 * for this <code>NMakefileSettings</code> instance using the elements contained
	 ...
	 * the settings for the NMake makefile generator.
	 * @exception ProjectFormatException
	...
	/**
	 * Public accessor for the <code>name</code> field.
	 *
	...
	/**
	 * Public mutator for the <code>name</code> field.
	 *
