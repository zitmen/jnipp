 ...
 * An instance is created by the
 * <code>Main</code> class where it is used to read in a project file. An
 * instance is also created by the GUI when creating a new or reading an
...
public class Project {
     ...
     *
     * @return The <code>Iterator</code> over the Peer Generator settings for
     * the project.
     ...
     *
     * @return The <code>NMakefileSettings</code> instance for the project
     * group.
     ...
     *
     * @param nMakefileSettings The <code>NMakefileSettings</code> instance to
     * be used for the project group.
     * @see #nMakefileSettings
     */
     ...
     *
     * @return The <code>GNUMakefileSettings</code> instance for the project
     * group.
     ...
     *
     * @param gnuMakefileSettings The <code>GNUMakefileSettings</code> instance
     * to be used for the project group.
     * @see #gnuMakefileSettings
     */
     ...
     *
     * @param outputDir The base directory for all code generated for this
     * project group.
     * @see #outputDir
     */
     ...
     *
     * This method is utilized to load and initialize this
     * <code>Project</code> instance with the data contained in the specified
     * project file. The project file is in an XML format with defined tags for
     * the various project attributes.
     *
    ...
    public void load(String fileName)
        ...
        for (int i = 0; i < childNodes.getLength(); ++i) {
            ...
            } else if (nodeName.equals("proxygen") == true) {
                addProxyGenSettings(new ProxyGenSettings(this, currentChild));
            } else if (nodeName.equals("nmakefile") == true) {
            ...
            } else if (nodeName.equals("gnumakefile") == true) {
     ...
     *
     * This method is utilized to save the project settings to the file whose
     * name is specified as parameter. All of the data is stored in a defined
     * XML format with defined tags for the various project attributes.
     *
     * @param fileName Name of project file to be loaded.
     * @exception IOException
     */
