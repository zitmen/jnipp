...
public class ProjectDetailsPane extends JTabbedPane implements
    ...
    /**
     * The default constructor creates the tabs and initializes the controls and
    ...
    /**
     * This method populates the ProjectDetailsPane with the project settings
     * and Peer and ProxyGenSettings
     *
     ...
     * ProjectDetailsPane responds to the UserContextUpdatedAppEvent and the
