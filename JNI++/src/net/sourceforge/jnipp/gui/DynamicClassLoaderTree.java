...
public class DynamicClassLoaderTree
        ...
        this.addTreeSelectionListener(new TreeSelectionListener() {
            ...
            public void valueChanged(TreeSelectionEvent e) {
                ...
                if (selectedNode.isLeaf()) {
                    selectedClass = getClassFromNode(selectedNode);
                }
            }
        });
    }
    ...
    private void createNodes(DefaultMutableTreeNode parent, PackageContents source) {
        ...
        while (it.hasNext() == true) {
            ...
            DefaultMutableTreeNode branch = new DefaultMutableTreeNode(pc.getName());
            parent.add(branch);
        ...
        while (it.hasNext() == true) {
            ...
            DefaultMutableTreeNode leaf = new DefaultMutableTreeNode(className);
            parent.add(leaf);
        }
    }
}
