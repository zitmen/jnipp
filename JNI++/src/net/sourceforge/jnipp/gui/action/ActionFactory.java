 ...
 * the <code> net.sourceforge.jnipp.gui.action </code> package.
 * This object implements the <i>FlyweightFactory</i> entity of the flyweight 
 * pattern.
 *
...
public class ActionFactory
{
	...
	/**
	 * This method returns an instance of an Action object for a given
	 * tag. This method is called by the dynamic menu building code found
	 * in <code>net.sourceforge.jnipp.gui.GuiUtils</code>
	 *
